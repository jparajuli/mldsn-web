...
const ADVISORS = [
  ...
  { name:"Dr. Binod Bhattarai", role:"Asst. Professor, University of Aberdeen/ Chief AI Scientist", location:"UK",    url:"https://scholar.google.com/citations?user=PDEi58sAAAAJ&hl=en", initials:"BB", color:"#a78bfa" },
];
  ...
  return (
    <section id="mission" style={{ padding:"100px clamp(20px,6vw,80px)", background:"var(--surface)", borderTop:"1px solid var(--border)", borderBottom:"1px solid var(--border)" }}>
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        ...
        <h2 style={{ fontFamily:"var(--ff-head)", fontWeight:700, fontSize:"clamp(1.55rem,2.4vw,2.1rem)", lineHeight:1.25, letterSpacing:"-0.02em", marginBottom:48, maxWidth:480 }}>Connecting Minds, Empowering Nepal Through AI, ML and DS</h2>
